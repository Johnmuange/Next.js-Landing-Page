        ...
        <Box sx={styles.contentWrapper}>
          ...
          <Box sx={styles.rightContent}>
            <SectionHeading
              emoji={emoji}
              sx={styles.heading}
              title="We have helped a dozen businesses worldwide achieve their dream"
              description="We understand your marketing needs helping you simplify the task with a great platform that unifies everything "
            />
            <Box sx={styles.learnMore}>
              <LearnMore path="https://3techagency.smblogin.com" />
            </Box>
          </Box>
        </Box>
      </Container>
