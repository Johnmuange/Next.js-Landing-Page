...
const data = [
  ...
  {
    id: 6,
    label: 'Organic Internet Marketing',
  },
];
        ...
        <Box sx={styles.contentWrapper}>
          <Box sx={styles.rightContent}>
            <SectionHeading
              emoji={emoji}
              sx={styles.heading}
              title="Don’t stress, be smart &amp; work smartly. Take a relax sit"
              description="We got a handful of digital marketing services that ignite the potential in your business."
            />
            ...
            <Box sx={styles.learnMore}>
              <LearnMore label="Explore more" path="https://3techageny.smblogin.com" />
            </Box>
          </Box>
          <Box sx={styles.illustration}>
            <Image src={workHard} alt="Relax" />
          </Box>
        </Box>
      </Container>
    </Box>
