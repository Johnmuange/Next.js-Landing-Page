      ...
      <Container>
        <Box sx={styles.footerTopInner}>
          <Box sx={styles.about}>
            ...
            <Box sx={styles.terms}>
              <Link path="https://3techagency.com/termsofservice">Terms of use</Link>
              <Text as="span">|</Text>
              <Link path="https://3techagency.com/privacypolicy">Privacy</Link>
            </Box>
            <Text as="p" sx={styles.copyright}>
              Copyright by {new Date().getFullYear()} 3techagency
            </Text>
          </Box>
